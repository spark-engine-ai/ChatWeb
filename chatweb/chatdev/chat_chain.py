...
from chatweb.camel.agents import RolePlaying
from chatweb.camel.configs import ChatGPTConfig
from chatweb.camel.typing import TaskType, ModelType
from chatweb.chatdev.chat_env import ChatEnv, ChatEnvConfig
from chatweb.chatdev.statistics import get_info
from chatweb.chatdev.utils import log_and_print_online, now
...
class ChatChain:
    ...
    def __init__(self,
        ...
        # import all used phases in PhaseConfig.json from chatweb.chatdev.phase
        ...
        self.compose_phase_module = importlib.import_module("chatweb.chatdev.composed_phase")
        self.phase_module = importlib.import_module("chatweb.chatdev.phase")
        self.phases = dict()
    ...
    def apply_stack_configuration(self):
        ...
        template_config_path = os.path.join('chatweb/ProjectConfig', self.stack_config)
    ...
    def execute_step(self, phase_item: dict):
        ...
        if phase_type == "SimplePhase":
            ...
            if phase in self.phases:
                ...
                raise RuntimeError(f"Phase '{phase}' is not yet implemented in chatweb.chatdev.phase")
        # For ComposedPhase, we create instance here then conduct the "ComposedPhase.execute" method
            ...
            if not compose_phase_class:
                raise RuntimeError(f"Phase '{phase}' is not yet implemented in chatweb.chatdev.compose_phase")
    ...
    def get_logfilepath(self):
        ...
        directory = home_directory.joinpath("chatweb/ProjectOutput")
    ...
    def pre_processing(self):
        ...
        source_template_dir = os.path.join('chatweb/ProjectConfig', template_config['template_path'])
