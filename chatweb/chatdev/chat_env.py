...
from chatweb.chatdev.codes import Codes
from chatweb.chatdev.documents import Documents
from chatweb.chatdev.roster import Roster
from chatweb.chatdev.utils import log_and_print_online
...
class ChatEnv:
    def __init__(self, chat_env_config: ChatEnvConfig, stack_config: str):
        ...
        template_config_path = os.path.join('chatweb/ProjectConfig', f"{stack_config}.json")
