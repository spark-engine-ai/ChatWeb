...
from chatweb.camel.messages import OpenAIMessage
from chatweb.camel.typing import ModelType, TaskType
...
def openai_api_key_required(func: F) -> F:
    ...
    def wrapper(self, *args, **kwargs):
        from chatweb.camel.agents.chat_agent import ChatAgent
