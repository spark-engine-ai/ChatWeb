...
* september 20. 2023: Režim **Human-Agent-Interaction** je teraz k dispozícii! Môžete sa zapojiť do tímu ChatDev tým, že budete hrať úlohu recenzenta <img src='../online_log/static/figures/reviewer.png' height=20> a predkladať návrhy programátorovi <img src='../online_log/static/figures/programmer.png' height=20>;
  skúste ``python3 run.py --task [description_of_your_idea] --config "Human"``. Pozri [návod](../wiki.md#human-agent-interaction) a [príklad](../projects/Gomoku_HumanAgentInteraction_20230920135038).
  <p align="center">
...
* september 1. 2023: Režim **Art** je už k dispozícii! Môžete si aktivovať agenta dizajnéra <img src='../online_log/static/figures/designer.png' height=20> na generovanie obrázkov používaných v programe;
  skúste ``python3 run.py --task [description_of_your_idea] --config "Art"``. Pozri [návod](../wiki.md#art) a [príklad](../projects/gomokugameArtExample_THUNLP_20230831122822).
...
5. **Generovanie softvéru:** Na spustenie generovania softvéru použite nasledujúci príkaz,
   ...
   ```
6. **Spustenie softvéru:** Po vygenerovaní nájdete svoj softvér v adresári `projects` pod konkrétnym
   ...
   V systéme Unix/Linux:
   ```
   cd projects/moj_projekt_DefaultOrganization_20231010224405
   python3 main.py
   ```
   Na Windowse
   ```
...
vytvorí softvérový balík a vygeneruje priečinok s názvom ``/projects/2048_THUNLP_timestamp``. V ňom nájdete:
...
Ak máte akékoľvek otázky, spätnú väzbu alebo by ste nás chceli kontaktovať, neváhajte nás kontaktovať e-mailom na adrese [laura.chatdev.openbmb@outlook.com](mailto:laura.chatdev.openbmb@outlook.com)
